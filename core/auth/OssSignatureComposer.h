...
#ifndef CORE_AUTH_OSSSIGNATURECOMPOSER_H_
#define CORE_AUTH_OSSSIGNATURECOMPOSER_H_

#include <map>

#include "../http/FormatType.h"
#include "../http/MethodType.h"
#include "RoaSignatureComposer.h"
...
class OssSignatureComposer : public RoaSignatureComposer {
 public:
 ...
 private:
  ...
  string buildQueryString(string uri, const std::map<string, string>& queries);
...
#endif  // CORE_AUTH_OSSSIGNATURECOMPOSER_H_
